const FEATURES = [
  ...
  { title: 'Team Chat', category: 'Communication', desc: 'Threaded discussions, announcements, and direct messaging — no more lost info in group chats.' },
  { title: 'Stats & Analytics', category: 'Performance', desc: 'From goals to attendance, track what matters. Visual dashboards make it easy to spot trends.' },
]
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map(({ title, category, desc }) => (
              <div key={title} className="bg-white rounded-2xl p-8 border border-navy/5 hover:shadow-xl hover:shadow-navy/5 transition-all group">
