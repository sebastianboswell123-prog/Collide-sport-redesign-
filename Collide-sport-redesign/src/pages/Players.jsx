      ...
      <section className="py-16 bg-lavender">
        <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {PLAYERS.map(({ id, name, sport, role, team }) => (
              <Link
                key={id}
                to={`/players/${id}`}
              ...
              >
                <div className="aspect-[3/4] bg-gradient-to-br from-navy/5 to-blue/10 relative flex items-end p-4">
                  <div>
                ...
                <div className="p-5">
                  ...
                  <p className="text-xs font-mono text-navy/30 mt-1">{team}</p>
                </div>
              </Link>
            ))}
          </div>
